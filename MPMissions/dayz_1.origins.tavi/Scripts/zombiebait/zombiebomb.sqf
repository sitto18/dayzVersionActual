...
sleep 1;
titleText ["Has colocado una tranoa para zombis. Corre!!.","PLAIN DOWN"]; titleFadeOut 5;
...
sleep 10;
titleText ["La trampa para zombis explotara en 2 minutos.","PLAIN DOWN"]; titleFadeOut 5;
sleep 60;
titleText ["La trampa para zombis explotara en 1 minuto.","PLAIN DOWN"]; titleFadeOut 5;
sleep 30;
titleText ["La trampa para zombis explotara en 30 segundos.","PLAIN DOWN"]; titleFadeOut 5;
sleep 20;
titleText ["La trampa para zombis explotara en 10 segundos.","PLAIN DOWN"]; titleFadeOut 5;
sleep 10;
